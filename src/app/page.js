...
export default function HomePage() {
  ...
  const featuredCategories = [
    ...
    { id: 4, name: 'MERCEARIA', subtitle: 'Queijos e Laticínios', image: 'https://images.unsplash.com/photo-1452195100486-9cc805987862?w=400&h=300&fit=crop', link: '/produtos?categoria=mercearia' },
  ];
